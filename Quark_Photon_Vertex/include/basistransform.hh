...
{
	std::complex<double> f1(const double Q, const double s, const double z,const double k, const vec_cmplx& a)
	{
	...
	std::complex<double> f5(const double Q, const double s, const double z,const double k, const vec_cmplx& a)
	{
